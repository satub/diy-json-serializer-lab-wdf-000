...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :description => "Default description is a long default description", :inventory => Faker::Number.between(0,55))
end
5.times do
